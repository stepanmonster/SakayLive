...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _loadConductorRequests() async {
    try {
      ...
      final userSnap = await FirebaseDatabase.instance
          .ref().child('users').child(FirebaseAuth.instance.currentUser!.uid).get();
      ...
      // 🔥 Start listener
      final requestsRef = FirebaseDatabase.instance.ref().child('conductorRequests');
 ...
 Future<void> _approveRequest(String uid) async {
  try {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('✅ Conductor approved & role assigned!')),
      );
    }
  } catch (e) {
                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final buttonWidth = screenWidth * 0.20 * 2 + screenWidth * 0.008; // Total buttons width
                                                  ...
                                                  ? [
                                                      ...
                                                      Expanded(
                                                        child: GestureDetector(
                                                          onTap: () => _approveRequest(request['userId']),
                                                          child: Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                              ...
                                                              boxShadow: [
                                                                BoxShadow(
                                                                  ...
                                                                  offset: Offset(0, screenWidth * 0.006),
                                                                ),
                                                              ],
                                                            ),
                                                            child: Center(
                                                      ...
                                                      Expanded(
                                                        child: GestureDetector(
                                                          onTap: () => _rejectRequest(request['userId']),
                                                          child: Container(
                                                            height: screenWidth * 0.11,
                                                            decoration: BoxDecoration(
                                                              gradient: LinearGradient(
