...
class TripSession {
  ...
  const TripSession({required this.isActive, this.startedAt, this.busId});
...
class TripStateController {
  ...
  final ValueNotifier<TripSession> session = ValueNotifier(
    const TripSession(isActive: false),
  );
          ...
          builder: (context, busStatus, __) {
            ...
            return ValueListenableBuilder<DateTime?>(
              ...
              builder: (context, lastUpdated, ___) {
                return Scaffold(
                  // ✅ FIX: Prevent keyboard from resizing UI
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // --- WATCH / STATUS DIAL ---
                          // Note: Removed Expanded to allow scrolling.
                          // Used Center to keep alignment nice.
                          Center(
                            child: Opacity(
                          ...
                          _bigStatusButton(
                            ...
                            onTap: () =>
                                _setStatus(BusStatus.green, tripActive),
                          ),
                          ...
                          _bigStatusButton(
                            ...
                            onTap: () =>
                                _setStatus(BusStatus.yellow, tripActive),
                          ),
                          const SizedBox(height: 12),
                          _bigStatusButton(
                            enabled: tripActive,
...
// SECTION 2/2 — Painters
// (Painters are unchanged but included for completeness)
